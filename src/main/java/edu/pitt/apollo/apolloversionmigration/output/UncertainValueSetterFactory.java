...
public class UncertainValueSetterFactory {
	...
	public static UncertainValueSetter getSetter(Object oldTypeInstance) throws MigrationException {
		...
		if (oldTypeInstance instanceof edu.pitt.apollo.types.v4_0.MeanMedianMinimumMaximum) {
			...
			return new MeanMedianMinimumMaximumSetter(edu.pitt.apollo.types.v4_0.MeanMedianMinimumMaximum.class, (edu.pitt.apollo.types.v3_1_0.MeanMedianMinimumMaximum) oldTypeInstance);
		}

		if (oldTypeInstance instanceof edu.pitt.apollo.types.v4_0.MeanWithConfidenceInterval) {

			return new MeanWithConfidenceIntervalSetter(edu.pitt.apollo.types.v4_0.MeanWithConfidenceInterval.class, (edu.pitt.apollo.types.v3_1_0.MeanWithConfidenceInterval) oldTypeInstance);
		}
		...
		if (oldTypeInstance instanceof edu.pitt.apollo.types.v4_0.MeanWithStandardDeviation) {
			...
			return new MeanWithStandardDeviationSetter(edu.pitt.apollo.types.v4_0.MeanWithStandardDeviation.class, (edu.pitt.apollo.types.v3_1_0.MeanWithStandardDeviation) oldTypeInstance);
		}
