...
public class ReceivingDestinationAndProbabilitySetter extends BehaviorSetter<edu.pitt.apollo.types.v4_0.ReceivingDestinationAndProbability> {

	public ReceivingDestinationAndProbabilitySetter(Class<edu.pitt.apollo.types.v4_0.ReceivingDestinationAndProbability> newTypeClass, Object oldTypeInstance) throws MigrationException {
		super(newTypeClass, oldTypeInstance);

	}

	protected void setReceivingDestination() throws MigrationException {
		newTypeInstance.setReceivingDestination(edu.pitt.apollo.types.v4_0.PlaceEnum.valueOf(((edu.pitt.apollo.types.v3_1_0.ReceivingDestinationAndProbability) oldTypeInstance).getReceivingDestination().toString()));
	}
