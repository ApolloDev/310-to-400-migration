...
public class ContainerReductionControlMeasureSetter extends VectorControlMeasureSetter<edu.pitt.apollo.types.v4_0_1.ContainerReductionControlMeasure> {

	public ContainerReductionControlMeasureSetter(Class<edu.pitt.apollo.types.v4_0_1.ContainerReductionControlMeasure> newTypeClass, Object oldTypeInstance) throws MigrationException {
		super(newTypeClass, oldTypeInstance);

	}

	protected void setCoverRadius() throws MigrationException {
		DistanceSetter setter = new DistanceSetter(edu.pitt.apollo.types.v4_0_1.Distance.class,((edu.pitt.apollo.types.v3_1_0.ContainerReductionControlMeasure) oldTypeInstance).getCoverRadius());
		setter.set();
