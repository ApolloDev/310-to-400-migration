...
public class InfectionSetter<T extends edu.pitt.apollo.types.v4_0.Infection> extends ApolloIndexableItemSetter<T> {
	...
	protected void setPathogen() throws MigrationException {
		ApolloPathogenCodeSetter setter = new ApolloPathogenCodeSetter(edu.pitt.apollo.types.v4_0.ApolloPathogenCode.class,((edu.pitt.apollo.types.v3_1_0.Infection) oldTypeInstance).getPathogen());
		setter.set();
	...
	protected void setInfectiousDiseases() throws MigrationException {
		for (edu.pitt.apollo.types.v3_1_0.InfectiousDisease oldObj : ((edu.pitt.apollo.types.v3_1_0.Infection) oldTypeInstance).getInfectiousDiseases()) {
			InfectiousDiseaseSetter setter = new InfectiousDiseaseSetterImpl(edu.pitt.apollo.types.v4_0.InfectiousDisease.class,oldObj);
			setter.set();
