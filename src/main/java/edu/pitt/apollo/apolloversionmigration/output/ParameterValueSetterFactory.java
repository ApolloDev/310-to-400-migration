...
public class ParameterValueSetterFactory {
	...
	public static ParameterValueSetter getSetter(Object oldTypeInstance) throws MigrationException {
		...
		if (oldTypeInstance instanceof edu.pitt.apollo.types.v3_1_0.ParameterValue) {

			return new ParameterValueSetter(edu.pitt.apollo.types.v4_0_1.ParameterValue.class, oldTypeInstance);
		}
