...
public class TransmissionTreeSetter extends AbstractSetter<edu.pitt.apollo.types.v4_0_1.TransmissionTree> {

	public TransmissionTreeSetter(Class<edu.pitt.apollo.types.v4_0_1.TransmissionTree> newTypeClass, Object oldTypeInstance) throws MigrationException {
		super(newTypeClass, oldTypeInstance);

	}

	protected void setThisCase() throws MigrationException {
		CaseRecordSetter setter = new CaseRecordSetter(edu.pitt.apollo.types.v4_0_1.CaseRecord.class,((edu.pitt.apollo.types.v3_1_0.TransmissionTree) oldTypeInstance).getThisCase());
		setter.set();
