...
public class ModelIdAndProbabilitySetter extends AbstractSetter<edu.pitt.apollo.types.v4_0_1.ModelIdAndProbability> {

	public ModelIdAndProbabilitySetter(Class<edu.pitt.apollo.types.v4_0_1.ModelIdAndProbability> newTypeClass, Object oldTypeInstance) throws MigrationException {
