...
public class IndividualBiologyAndBehaviorSetter extends AbstractSetter<edu.pitt.apollo.types.v4_0.IndividualBiologyAndBehavior> {

	public IndividualBiologyAndBehaviorSetter(Class<edu.pitt.apollo.types.v4_0.IndividualBiologyAndBehavior> newTypeClass, Object oldTypeInstance) throws MigrationException {
		super(newTypeClass, oldTypeInstance);

	}

	protected void setLifeCycle() throws MigrationException {
		LifeCycleSetter setter = new LifeCycleSetter(edu.pitt.apollo.types.v4_0.LifeCycle.class,((edu.pitt.apollo.types.v3_1_0.IndividualBiologyAndBehavior) oldTypeInstance).getLifeCycle());
		setter.set();
